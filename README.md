...
1.INTRODUCTION Welcome to use SUN Flashlight Widget! Your use of Product is subject to these Terms (“Service” or “Our Service”).

The SUN Flashlight Widget a night patrol. The best weapon in the dark against ungodliness. Absolutely free and unique application.

Your use of SUN Flashlight Widget is subject to the terms and conditions of these Terms of Use (“Terms”). Please read these Terms carefully.

You must comply with these Terms in your use of SUN Flashlight Widget and only use SUN Flashlight Widget as permitted by applicable laws and regulations, wherever you may be when you use it. You must review these Terms to understand how you can and cannot use SUN Flashlight Widget. If you do not agree to these Terms, you must not download or install or otherwise use SUN Flashlight Widget.
...
2.CONTRACTING ENTITY By downloading, installing and using SUN Flashlight Widget, you are agreeing to be bound by these Terms between you and SUN Flashlight Widget Team (“We”, “Our” and “Us”).
...
5.SCOPE OF LICENSE Although we continue to own SUN Flashlight Widget, after your acceptance of these Terms you will have certain rights to use SUN Flashlight Widget during the entire time period when SUN Flashlight Widget is installed on your mobile device. All rights not expressly granted to you are retained by us. These Terms govern any releases, revisions, updates or enhancements to SUN Flashlight Widget that we may make available to you.

You may install, use, display and run SUN Flashlight Widget in a personal computer (“Device”) solely for non-commercial purposes and in accordance with these Terms. Installation, use, display or operation of SUN Flashlight Widget for commercial purposes is forbidden.

You shall have the right to receive new features to and versions of SUN Flashlight Widget as we, in our sole discretion, make such features and versions available. In order to optimize SUN Flashlight Widget, and to provide you with the most current version of SUN Flashlight Widget, you agree SUN Flashlight Widget can automatically download and install new updates and versions of the SUN Flashlight Widget as they are made available by us in our sole discretion. You agree to receive and permit us to deliver such new updates and versions to your mobile device. Additionally, we may modify these Terms to reflect such updates and versions and you agree to such updated terms.

You may not copy, modify, reverse compile, reverse engineer or extract source codes from SUN Flashlight Widget, except to the extent that we may not prohibit you from doing so under applicable laws or regulations or you have our prior written consent to do so. Where applicable laws or regulations entitle you to reverse compile or extract source codes from SUN Flashlight Widget, you will first contact us to request the information you need.
...
a)the collection of the information as how you use SUN Flashlight Widget (such as the time when you install SUN Flashlight Widget, version of SUN Flashlight Widget you are using, how you use the various functions and features that available to you), the information about your mobile device (such asthe operating system, hardware version, device settings, device identifiers) and your communication with us
...
10.TERMINATION These Terms will apply to your use of SUN Flashlight Widget and Our Service until access to the relevant services is terminated by either you or us.
